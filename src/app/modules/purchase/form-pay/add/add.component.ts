...
export class AddFormPayComponent implements OnInit {
  ...
  constructor(
    private service: BaseService<FormaPagamento>,
    private formBuilder: FormBuilder,
    private route: ActivatedRoute,
    private router: Router,
    private alert: AlertService
  ) {
    service.type = 'formas-pagamentos';
  }

  ngOnInit(): void {
    this.service.type = 'formas-pagamentos';
    ...
    this.service.update(this.form.value, Number(this.id))
      ...
      .subscribe(
        (res) => {
          ...
          this.router.navigate(['/Compras/Pagamentos/form'], { relativeTo: this.route })
        },
        (err) => {
          this.alert.error("Ops... Aconteceu um probleminha!");
          this.loading = false
