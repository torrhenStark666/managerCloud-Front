...
export class AddTypeProviderComponent implements OnInit {
  ...
  constructor(
    private service: BaseService<TipoFornecedor>,
    private formBuilder: FormBuilder,
    private route: ActivatedRoute,
    private router: Router,
    private alert: AlertService
  ) {
    service.type = 'tipos-fornecedores';
  }
  ...
  ngOnInit(): void {
    ...
    this.service.type = 'tipos-fornecedores';
    ...
    this.service.update(this.form.value, Number(this.id))
      ...
      .subscribe(
        (res) => {
          ...
          this.router.navigate(['/Compras/Fornecedores/tipo'], { relativeTo: this.route })
        },
        (err) => {
          this.alert.error("Ops... Aconteceu um probleminha!");
          this.loading = false
