...
export class AddGroupProductComponent implements OnInit {
  ...
  constructor(
    private service: BaseService<GrupoProduto>,
    private formBuilder: FormBuilder,
    private route: ActivatedRoute,
    private router: Router,
    private alert: AlertService
  ) {
    service.type = 'grupos-produtos';
  }

  ngOnInit(): void {
    this.service.type = 'grupos-produtos';
    ...
    this.service.update(this.form.value, Number(this.id))
      ...
      .subscribe(
        (res) => {
          ...
          this.router.navigate(['/Compras/Produtos/grupo'], { relativeTo: this.route })
        },
        (err) => {
          this.alert.error("Ops... Aconteceu um probleminha!");
          this.loading = false
