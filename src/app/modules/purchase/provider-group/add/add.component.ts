...
export class AddGroupProviderComponent implements OnInit {
  ...
  constructor(
    private service: BaseService<GrupoFornecedor>,
    private formBuilder: FormBuilder,
    private route: ActivatedRoute,
    private router: Router,
    private alert: AlertService
  ) {
    service.type = 'grupos-fornecedores';
  }

  ngOnInit(): void {
    this.service.type = 'grupos-fornecedores';
