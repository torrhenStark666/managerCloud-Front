...
export class AddTypeProductComponent implements OnInit {
  ...
  constructor(
    private service: BaseService<TipoProduto>,
    private formBuilder: FormBuilder,
    private route: ActivatedRoute,
    private router: Router,
    private alert: AlertService
  ) {
    service.type = 'tipos-produtos';
  }

  ngOnInit(): void {
    this.service.type = 'tipos-produtos';
    ...
    this.service.update(this.form.value, Number(this.id))
      ...
      .subscribe(
        (res) => {
          ...
          this.router.navigate(['/Compras/Produtos/tipo'], { relativeTo: this.route })
        },
        (err) => {
          this.alert.error("Ops... Aconteceu um probleminha!");
          this.loading = false
